...
(function (EIGame) {
    var Test = (function () {
        ...
        Test.socketTest = function () {
            // ei_network.Instance().initConnect("ws://localhost:8181", (e)=>{
        ...
        Test.httpTest = function () {
            var p_role_base = EIGame.ProtocolManager.getRoot().lookup("p_role_base").create({
                playerId: 1001.0,
                playerName: "nihao",
                accountName: "hello",
                head: 1001,
            ...
            var pb_buffer = EIGame.ProtocolManager.encodeMsg(1001, {
                apkVersion: "v1.1",
                queueNum: 100,
                createRole: 199,
                serverTime: 11111.0,
            ...
            var pb_msg = EIGame.ProtocolManager.decodeMsg(1001, pb_buffer);
