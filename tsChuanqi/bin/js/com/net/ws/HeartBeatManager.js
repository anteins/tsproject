...
(function (EIGame) {
    var HeartBeatManager = (function (_super) {
        ...
        HeartBeatManager.prototype.init = function () {
            this.checkHeartBeat();
            this.ping_packet = EIGame.ProtobufHelper.Instance().encodeMsg(1004, {
                ping: 1,
            });
        };
        HeartBeatManager.prototype.checkHeartBeat = function () {
            ...
            this.sendCellFunc = setTimeout(function () {
                if (!EIGame.NetWork.Instance().connected() || !EIGame.NetWork.Instance().IsOnline())
                    return;
        ...
        HeartBeatManager.prototype.sendPingPacket = function () {
            if (this.ping_packet) {
                EIGame.NetWork.Instance().sendPacket(1004, this.ping_packet);
            }
        };
        ;
