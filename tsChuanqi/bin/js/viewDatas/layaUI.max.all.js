    ...
    (function (test) {
        var GameSceneUI = (function (_super) {
            ...
            GameSceneUI.prototype.createChildren = function () {
                ...
                this.createView(viewDatas.test.GameSceneUI.uiView);
            };
            GameSceneUI.uiView = { "type": "View", "props": { "width": 1024, "height": 640 }, "child": [{ "type": "Image", "props": { "y": 3, "x": 3, "width": 1024, "var": "GAME_IMG_BG", "skin": "comp/bg.png", "name": "GAME_IMG_BG", "height": 640 } }, { "type": "Button", "props": { "y": 103, "x": 57, "width": 217, "var": "GAME_BTN_CHANGE", "skin": "comp/button.png", "sizeGrid": "4,4,4,4", "name": "GAME_BTN_CHANGE", "label": "切换账号", "height": 54 } }, { "type": "Button", "props": { "y": 102, "x": 392, "width": 217, "var": "GAME_BTN_BREAK", "skin": "comp/button.png", "sizeGrid": "4,4,4,4", "name": "GAME_BTN_BREAK", "label": "掉线", "height": 54 } }, { "type": "Button", "props": { "y": 104, "x": 757, "width": 217, "var": "GAME_BTN_EXIT", "skin": "comp/button.png", "sizeGrid": "4,4,4,4", "name": "GAME_BTN_EXIT", "label": "退出游戏", "height": 54 } }] };
            return GameSceneUI;
        }(View));
        test.GameSceneUI = GameSceneUI;
    })(test = viewDatas.test || (viewDatas.test = {}));
})(viewDatas || (viewDatas = {}));
(function (viewDatas) {
    var test;
    (function (test) {
    ...
    (function (test) {
        var MainBgUI = (function (_super) {
            ...
            MainBgUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(viewDatas.test.MainBgUI.uiView);
            };
    ...
    (function (test) {
        var TestPageUI = (function (_super) {
            ...
            TestPageUI.prototype.createChildren = function () {
                _super.prototype.createChildren.call(this);
                this.createView(viewDatas.test.TestPageUI.uiView);
            };
