    ...
    var Test = (function () {
        ...
        Test.Instance = function () {
            if (this.mInstance == null) {
                this.mInstance = new EIGame.ei_network();
            }
        ...
        Test.socketTest = function () {
            EIGame.ei_network.Instance().initConnect("ws://localhost:8181", function (e) {
        ...
        Test.httpTest = function () {
            EIGame.pbManager.Instance().load("pb.proto", function (err, root) {
                var p_role_base = root.lookup("p_role_base").create({
                    playerId: 1001.0,
                    playerName: "nihao",
                    accountName: "hello",
                    head: 1001,
                ...
                var pb_buffer = EIGame.pbManager.Instance().encodeMsg("pb.proto", 1001, {
                    apkVersion: "v1.1",
                    queueNum: 100,
                    createRole: 199,
                    serverTime: 11111.0,
                ...
                var pb_msg = EIGame.pbManager.Instance().decodeMsg("pb.proto", 1001, pb_buffer);
