module EIGame{
    export class Test{
        ...
        public static httpTest():void{
            var p_role_base:any = ProtobufHelper.getRoot().lookup("p_role_base").create({
                playerId:1001.0,
                playerName:"nihao",
                accountName:"hello",
                head:1001,
            ...
            var pb_buffer:any = ProtobufHelper.encodeMsg(1001, {
                apkVersion:"v1.1",
                queueNum:100,
                createRole:199,
                serverTime:11111.0,
            ...
            var pb_msg = ProtobufHelper.decodeMsg(1001, pb_buffer);
