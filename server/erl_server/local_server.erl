...
start(F, State0) ->
    {ok, Listen} = gen_tcp:listen(8181, [{packet,raw}, {reuseaddr,true}, {active, true}]),
...
par_connect(Listen, F, State0) ->
    case gen_tcp:accept(Listen) of
        ...
        {error, closed} ->
            {ok, Listen2} = gen_tcp:listen(8181, [{packet,raw}, {reuseaddr,true}, {active, true}]),
